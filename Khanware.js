...
function setupMenu() {
    ...
    function setupDropdown() {
        ...
        let featuresList = [
            ...
            [{ name: 'autoAnswer', type: 'checkbox', variable: 'features.autoAnswer', dependent: 'autoAnswerDelay,nextRecomendation,repeatQuestion', labeled: true, label: 'Responder automatico' },
